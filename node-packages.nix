...
let
  sources = {
    ...
    "tailwindcss-2.1.2" = {
      ...
      version = "2.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/tailwindcss/-/tailwindcss-2.1.2.tgz";
        sha512 = "T5t+wwd+/hsOyRw2HJuFuv0LTUm3MUdHm2DJ94GPVgzqwPPFa9XxX0KlwLWupUuiOUj6uiKURCzYPHFcuPch/w==";
      };
    };
